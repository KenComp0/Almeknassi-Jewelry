export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 md:bottom-7 left-5 z-[60] w-[56px] h-[56px] bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_6px_20px_rgba(0,0,0,0.2)] hover:scale-105 transition-transform duration-300"
    >
