          ...
          >
            {[
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-full border border-[#C9A86A] text-[#C9A86A] hover:bg-[#C9A86A] hover:text-black transition-colors text-sm tracking-widest uppercase"
              >
                {l.label}
              </button>
            ))}
